...
public class TC_CodesPaginationValidation extends GenericFunctions{
	...
	@Parameters({"paginationCheck","TestName"})
	@Test
	public void paginationCheck(String testCaseID, String testName)
	{
